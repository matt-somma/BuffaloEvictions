...
SETTINGS_PATH = CONFIG_DIR / "public_label_settings.json"
ALIASES_PATH = CONFIG_DIR / "public_neighborhood_aliases.csv"
TRACT_ALIASES_PATH = CONFIG_DIR / "public_tract_aliases.csv"
